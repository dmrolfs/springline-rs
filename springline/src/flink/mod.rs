...
pub(crate) use model::catalog::{
    ...
    METRIC_CATALOG_FLOW_IDLE_TIME_MILLIS_PER_SEC, METRIC_CATALOG_FLOW_INPUT_MILLIS_BEHIND_LATEST,
    METRIC_CATALOG_FLOW_INPUT_RECORDS_LAG_MAX, METRIC_CATALOG_FLOW_RECORDS_IN_PER_SEC,
    METRIC_CATALOG_FLOW_RECORDS_OUT_PER_SEC, METRIC_CATALOG_JOB_HEALTH_NR_COMPLETED_CHECKPOINTS,
