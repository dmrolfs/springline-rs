...
pub use model::catalog::{
    ...
    MC_FLOW__FORECASTED_TIMESTAMP, MC_FLOW__RECORDS_IN_PER_SEC, MC_HEALTH__JOB_MAX_PARALLELISM,
};
pub(crate) use model::catalog::{
    ...
    METRIC_CATALOG_FLOW_SOURCE_MILLIS_BEHIND_LATEST, METRIC_CATALOG_FLOW_SOURCE_RECORDS_CONSUMED_RATE,
    METRIC_CATALOG_FLOW_SOURCE_RECORDS_LAG_MAX, METRIC_CATALOG_FLOW_SOURCE_TOTAL_LAG,
...
pub(crate) use model::window::{
    ...
    METRIC_CATALOG_FLOW_SOURCE_TOTAL_LAG_1_MIN_ROLLING_AVG, METRIC_CATALOG_FLOW_TASK_UTILIZATION_1_MIN_ROLLING_AVG,
};
